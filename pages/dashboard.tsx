...
import { Anchor, Button, Checkbox, CheckboxProps, Flex, Group, Loader, MediaQuery, Stack, Switch, Text, Title } from '@mantine/core';
	...
	return (
		<Stack
			...
			<Stack spacing={6} ml="lg">
				...
				<Text>
					For additional information, see the <Anchor href="https://pickhacks.io">the main pickhacks page</Anchor> and{' '}
					<Anchor href="https://discord.gg/K6uwZUcaff">join our discord</Anchor> to keep in touch!
				</Text>
			</Stack>
		</Stack>
	);
...
const Dashboard: NextPage = () => {
	...
	return (
		<MediaQuery query="(max-width: 1300px)" styles={{ paddingLeft: '100px' }}>
			<Flex justify="center" align="center" direction="column" gap={40} style={{ height: '100%' }}>
				<MediaQuery query="(max-width: 1100px)" styles={{ flexDirection: 'column' }}>
					<Flex mt={20}>
